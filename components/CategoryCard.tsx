...
// Assuming types are in '@/types', adjust if your path is different
  ...
  return (
    <Card
      ...
      <Image
        ...
        // Apply object-cover, ensure it covers the whole area, add z-index if needed (usually 0 is fine for background)
      ...
      {/* Ensure it has a higher z-index than the image */}
