...
import MenuModal from "@/components/Casa_playa/MenuModalCasaPlaya"; // Adjusted import path
...
import { casa_playa_MenuCategories } from "@/constants/casa_playa";
import { translations } from "@/constants/monk";
...
const CasaPlaya = () => {
  ...
  ); // Assuming mockMenuCategories is an array of MenuCategory
  ...
  return (
    ...
    <div className="min-h-screen text-[#fffdfe] antialiased bg-[#ffffff]">
      {/* Inner container */}
      <div className="container mx-auto px-3 sm:px-4 pb-12 relative">
          ...
          <Select
            ...
            <SelectTrigger
              className={cn(
                ...
                "bg-[#f4e4c4] backdrop-blur-sm border-black hover:text-black/80 text-black",
            ...
            <SelectContent className="bg-[#f4e4c4] border-black text-xs sm:text-sm">
              <SelectItem
                value="en"
                className="hover:bg-gray-700/50 text-black focus:bg-black/50 cursor-pointer min-h-[32px] sm:min-h-0 focus:ring-0 focus:outline-none">
                English
              </SelectItem>
              <SelectItem
                value="gr"
        ...
        {/* Menu Title */}
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#6b3e21] mb-6 md:mb-8 text-center drop-shadow-md">
          {" "}
