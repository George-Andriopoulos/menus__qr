...
const CategoryCard: React.FC<CategoryCardProps> = ({
  ...
  return (
    <Card
      ...
      className="overflow-hidden text-[#fffdfe] transition-all lg:mt-10 lg:w-[270px]  duration-300 hover:shadow-xl hover:scale-[1.03] cursor-pointer group bg-gray-800 border-[#603913] active:scale-[0.98] relative h-48 focus:outline-none focus:ring-0"
